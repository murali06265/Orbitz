# Orbitz
Download zipfile 'OrbitzTask.zip' to local machine
Unzip the file
Import in to your editor say 'Eclipse'
Run the OrbitzDriver.java
Script will launch browser and will perform all the activities given in the task below
